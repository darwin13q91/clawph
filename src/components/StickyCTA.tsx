...
export default function StickyCTA() {
  ...
  return (
    <div className={`fixed bottom-0 left-0 right-0 z-[40] md:hidden transition-opacity duration-150 ${show ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
      <div className="relative bg-jungle/95 backdrop-blur-lg border-t border-warm/10 p-4 pb-[calc(16px+env(safe-area-inset-bottom))] mt-2">
        <button 
