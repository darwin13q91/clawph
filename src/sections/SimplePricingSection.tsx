...
const packages = [
  {
    ...
    tagline: 'River-powered intelligence available 24/7',
    price: '$997',
    originalPrice: '$1,997',
    badge: '50% Off Founding Price',
    description: 'Custom River AI agent that analyzes 10,000+ data points and delivers insights. One-time setup — you own it forever.',
    features: [
      'River AI agent with 23 specialized Amazon modes',
  ...
  },
  {
    ...
    tagline: 'River-powered Amazon guidance & strategy',
    price: '$999/mo',
    originalPrice: '$1,999/mo',
    badge: 'Amazon FBA Service',
    badgeColor: 'amazon',
    description: 'River-powered strategic guidance for listings, PPC, inventory, and growth. You implement, we advise.',
    features: [
      'River-powered listing optimization recommendations',
