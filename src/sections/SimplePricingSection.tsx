...
const packages = [
  {
    ...
    tagline: 'AI intelligence available 24/7',
    price: '$997',
    originalPrice: '$1,997',
    badge: '50% Off Founding Price',
    description: 'Custom AI agent that analyzes your Amazon data and delivers insights. One-time setup — you own it forever.',
    features: [
  ...
  },
  {
    ...
    icon: TrendingUp,
    name: 'Amazon Growth',
    tagline: 'Expert Amazon guidance & strategy',
    price: '$999/mo',
    originalPrice: '$1,999/mo',
    badge: 'Amazon FBA Service',
    badgeColor: 'amazon',
    description: 'Strategic guidance for listings, PPC, inventory, and growth. You implement, we advise.',
    features: [
